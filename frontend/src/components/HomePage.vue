...
<template>
  <div class="home-page">
    <h1 class="text-4xl font-bold text-center mb-8">
      Welcome to Song Writer AI
    </h1>
    <p class="text-center mb-8">
      Generate amazing song drafts with the power of AI!
    </p>
...
export default {
  ...
  setup() {
    ...
    const generateDrafts = async (songIdea, numberOfDrafts, useOpenAI) => {
      ...
      try {
        const drafts = await api.generateSongDrafts(
          songIdea,
          numberOfDrafts,
          useOpenAI
        )
        ...
        error.value =
          'An error occurred while generating song drafts. Please try again.'
      } finally {
